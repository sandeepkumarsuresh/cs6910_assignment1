...
parser.add_argument("-l", "--loss", 
                    ...
                    default="cre",
                    choices=["mse", "cre"],
                    help="Loss function to use. Choices: ['mse', 'cre']")
...
parser.add_argument("-a", "--activation", 
                    ...
                    help="Activation function to use. Choices: [ 'sigmoid', 'tanh', 'relu']")
...
def normalise(data):
    """
    Normalize input data by dividing it by 255.

    Parameters:
    - data (numpy.ndarray): Input data to be normalized.

    Returns:
    - numpy.ndarray: Normalized data obtained by dividing input data by 255.
...
def main(args):
    """
    Main Function which takes all the argument and performs a run


    Returns:
    - None

    This prints the log in the command line and logs the data in wandb
